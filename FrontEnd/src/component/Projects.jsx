      ...
      >
        {cleanProjects.map((p) => (
          <Motion.div
            ...
            whileHover={{ y: -6 }}
            onClick={() => setActive(p)}
            className="cursor-pointer bg-white rounded-2xl overflow-hidden shadow-[0_12px_35px_rgba(0,0,0,0.14)]hover:shadow-[0_22px_55px_rgba(0,0,0,0.2)] transition border border-gray-100"
          >
            {/* Thumbnail*/}
            <img
