  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden font-[Poppins]">
      ...
      <Motion.button
        ...
        whileTap={tap}
        onClick={() => navigate("/")}
        className="absolute top-6 left-6 z-20 flex items-center gap-2 px-4 py-2 rounded-xl bg-white/60 backdrop-blur border shadow-md"
      >
        <ArrowLeft size={18} />
        Back Home
      </Motion.button>
      ...
      <Motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative z-10 bg-white/80 backdrop-blur-lg border shadow-[0_8px_30px_rgba(0,0,0,0.15)] p-10 rounded-2xl w-[380px] sm:w-[450px]"
      >
